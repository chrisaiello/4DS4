...
always_ff @ (posedge clock or negedge resetn) begin
	...
	if (reset_counter) begin
		...
		end else if (load_config_buf == 'd1) begin
			counter_value <= 'd37499999;
		end else if (load_config_buf == 'd2) begin
			counter_value <= 'd24999999;
		end else if (load_config_buf == 'd3) begin
			counter_value <= 'd12499999;
